...
// 写入文件
const fs = require('fs');
fs.writeFileSync('ini-validation-test.html', testHTML);

console.log('✅ INI配置验证测试页面已创建: ini-validation-test.html');
console.log('📖 使用方法:');
console.log('1. 在浏览器中打开 ini-validation-test.html');
console.log('2. 粘贴您的INI配置');
console.log('3. 点击"验证配置"按钮');
console.log('4. 查看验证结果和统计信息');
console.log('');
console.log('🎯 这个工具可以帮助您:');
console.log('- 验证INI配置语法是否正确');
console.log('- 查看解析出的代理组和规则集数量');
console.log('- 检查配置是否包含必要的代理组');
console.log('- 测试配置在保存前是否有效');
